        ...
        Send.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                try {
                    ...
                    Logger.getLogger(CNIT255GroupProjectv2.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
 ...
 */
    ...
    private void SendActionPerformed(java.awt.event.ActionEvent evt) throws InterruptedException { //Sends message to Message class
        String Mess = Message.getText();

        Mess = Room.CurrentUser+": "+Mess+"\r";
        Messages Note = new Messages(Mess);
        Room.SendMessage(Note);
        if(Message.getText().equals("Hey")){
            Mess = "Frank: Hey, What's up?";
            Messages Note2 = new Messages(Mess);
            Room.SendMessage(Note2);
        }
        else if(Message.getText().equals("Nothing much")){
            Mess = "Frank: Cool";
            Messages Note2 = new Messages(Mess);
            Room.SendMessage(Note2);
        }
